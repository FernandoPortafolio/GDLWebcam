...
<body>
                ...
                <div class="caja flex-resp">
                    <div class="extras">
                        <div class="orden">
                            ...
                            <input type="number" min="0" id="camisas" size="3" placeholder="0">
                        </div>
                        <div class="orden">
                    ...
                    <div class="total">
                        ...
                        <input type="submit" id="btnRegistro" class="btn btn-primario">
                    </div>
                </div>
            </div>
    ...
    <!-- Paginas -->
    <script src="js/pages/registro.js" defer></script>
