    ...
    <form id="registro" class="registro" action="pagar.php" method="POST">
        ...
        <div id="resumen" class="resumen">
            ...
            <div class="caja flex-resp">
                <div class="extras">
                    <div class="orden">
                        <label for="camisa_evento">Camisa del Evento $10 <small>(promocion 7% de
                                descuento)</small></label>
                        <input type="number" min="0" id="camisas" name="pedido_extra[camisas][cantidad]" size="3" placeholder="0">
                    ...
                    <input type="button" id="calcular" class="btn btn-primario hollow" value="Calcular">
                </div>

                <div class="total">
                    <p>Resumen:</p>
                    <div id="lista-productos" class="justify-left">

                    </div>
                    <p>Total:</p>
                    <div id="suma-total" class="justify-left">

                    </div>
                    <!-- Un campo oculto para pasar el total a la pagina php por post -->
                    <input type="hidden" name="total" id="total">
                    <input disabled name="submit" type="submit" id="btnRegistro" class="btn btn-primario" value="pagar">
                </div>
            </div>
        </div>
